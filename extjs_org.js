var CodeMirror = (function () {
    function u(aM, aJ) {
        ...
        var bX = aD.firstChild, bm = bX.firstChild, bk = aD.lastChild, bM = bk.firstChild, cg = bM.firstChild, aH = cg.firstChild, aY = aH.firstChild, bu = aH.nextSibling.firstChild, av = bu.firstChild, bc = av.nextSibling, bg = bc.nextSibling, aq = bg.nextSibling;
        cD();
        if (s) {
            bm.style.width = "0px"
        }
        ...
        bT();
        var cW = {from: {line: 0, ch: 0}, to: {line: 0, ch: 0}, inverted: false};
        var ci, bq, aZ, bF = 0, bb, cn = false, cs = false;
        var cp, b6, aB, cN, aP, bf, aS, cA;
        var bd = 0, cQ = 0, bL = 0, bN = 0;
        var b4;
        var bD = "", aF;
        var ap = {};
        ar(function () {
        ...
        var b9 = aD.CodeMirror = {
            ...
            addWidget: function (c3, c1, c5, c2, c7) {
                ...
                if (c2 == "over") {
                    ...
                    if (c2 == "near") {
                        var cZ = Math.max(bk.offsetHeight, cy.height * bP()), c6 = Math.max(bM.clientWidth, bu.clientWidth) - a5();
        ...
        function aW(cZ) {
            var c0 = {line: 0, ch: 0};
            aO(c0, {line: cy.size - 1, ch: cF(cy.size - 1).text.length}, A(cZ), c0, c0);
            cp = true
        }
        ...
        function an(c3) {
            ...
            c3.preventDefault();
            var c6 = a2(c3, true), c0 = c3.dataTransfer.files;
            if (!c6 || b1.readOnly) {
                return
            }
            if (c0 && c0.length && window.FileReader && window.File) {
                ...
                var c5 = c0.length, c4 = Array(c5), c1 = 0;
        ...
        function cL(c5) {
            ...
            var c0 = R[y(c5, "keyCode")], c4 = false;
        ...
        function bn(c2) {
            ...
            var c1 = y(c2, "keyCode"), cZ = y(c2, "charCode");
        ...
        function ca(c4, c5) {
            ...
            for (var c1 = c6.length - 1; c1 >= 0; c1 -= 1) {
                var c3 = c6[c1];
                var c7 = [], cZ = c3.start + c3.added;
                cy.iter(c3.start, cZ, function (c8) {
                    c7.push(c8.text)
                });
                c0.push({start: c3.start, added: c3.old.length, old: c7});
                var c2 = aT({line: c3.start + c3.old.length - 1, ch: W(c7[c7.length - 1], c3.old[c3.old.length - 1])});
                at({line: c3.start, ch: 0}, {line: cZ - 1, ch: cF(cZ - 1).text.length}, c3.old, c2, c2)
            }
            cp = true;
            c5.push(c0)
        }
        ...
        function at(de, c3, dk, cZ, dl) {
            ...
            var db = c3.line - de.line, da = cF(de.line), c0 = cF(c3.line);
        ...
        function bK() {
            ...
            ci = null;
            var c1 = 0, cZ = Math.min(ba.length, c0.length);
            ...
            if (c1 < ba.length) {
                ...
                if (cn && ad(cW.from, cW.to)) {
                    cW.to = {line: cW.to.line, ch: Math.min(cF(cW.to.line).text.length, cW.to.ch + (c0.length - c1))}
                }
            }
            bs(c0.slice(c1), "end");
            ba = c0;
        ...
        function aA(c1, c7, cZ, c6) {
            ...
            c1 += c4;
            cZ += c4;
            var c9 = bk.clientHeight, c2 = bk.scrollTop, c0 = false, db = true;
            if (c7 < c2) {
            ...
            var c8 = bk.clientWidth, da = bk.scrollLeft;
        ...
        function cd(c7, c3) {
            ...
            var c8 = Math.max(c2.from - 100, 0), c9 = Math.min(cy.size, c2.to + 100);
            if (cQ < c8 && c8 - cQ < 20) {
                c8 = cQ
            }
            if (bL > c9 && bL - c9 < 20) {
        ...
        function b0(c8, c6) {
            for (var c3 = 0, c1 = c6.length || 0; c3 < c1; ++c3) {
                var c5 = c6[c3], cZ = [], c7 = c5.diff || 0;
                for (var c2 = 0, c0 = c8.length; c2 < c0; ++c2) {
                    var c4 = c8[c2];
                    if (c5.to <= c4.from && c5.diff) {
                        cZ.push({from: c4.from + c7, to: c4.to + c7, domStart: c4.domStart})
                    } else {
                        if (c5.to <= c4.from || c5.from >= c4.to) {
                            ...
                            if (c5.to < c4.to) {
                                cZ.push({from: c5.to + c7, to: c4.to + c7, domStart: c4.domStart + (c5.to - c4.from)})
                            }
                        }
                    }
                }
        ...
        function aR(c8, c9, db) {
            ...
            var c5 = db.shift(), c1 = aq.firstChild, c2 = c8;
        ...
        function aL() {
            ...
            var c0 = cg.offsetHeight, c8 = bk.clientHeight;
            ...
            if (c7 != null) {
                ...
                var c3 = String(cy.size).length, cZ = H(c2), c1 = "";
        ...
        function cV() {
            ...
            var c6 = cW.inverted ? dd : c8, c0 = bP();
            var cZ = ak(aD), c1 = ak(aq);
        ...
        function bR(c4, c0, c1) {
            function c3(c7) {
                var c9 = c4.line + c7, c6 = c7 == 1 ? cy.size : -1;
                while (c9 != c6) {
                    var c5 = cF(c9);
                    if (!c5.hidden) {
                        var c8 = c4.ch;
        ...
        function aT(c1) {
            ...
            var cZ = c1.ch, c0 = cF(c1.line).text.length;
            if (cZ == null || cZ > c0) {
        ...
        function co(c2, c6) {
            var c3 = cW.inverted ? cW.from : cW.to, c7 = c3.line, cZ = c3.ch;
            var c5 = cF(c7);
        ...
        function cx(cZ, c0) {
            var c2 = 0, c3 = cR(cW.inverted ? cW.from : cW.to, true);
            if (cv != null) {
                c3.x = cv
            }
            if (c0 == "page") {
        ...
        function a9(c0) {
            var cZ = b1.tabSize - c0 % b1.tabSize, c2 = ap[cZ];
            if (c2) {
                return c2
            }
        ...
        cX.prototype.clear = ar(function () {
            var c4 = Infinity, c0 = -Infinity;
            for (var c3 = 0, c6 = this.set.length; c3 < c6; ++c3) {
                var c1 = this.set[c3], cZ = c1.marked;
                if (!cZ || !c1.parent) {
                    continue
                }
                var c5 = Y(c1);
        ...
        cX.prototype.find = function () {
            ...
            for (var c1 = 0, c3 = this.set.length; c1 < c3; ++c1) {
                var c7 = this.set[c1], c2 = c7.marked;
        ...
        function cK(c0, cZ) {
            return aX(c0, function (c1, c4) {
                if (c1.hidden != cZ) {
                    c1.hidden = cZ;
                    a3(c1, cZ ? 0 : 1);
                    var c3 = cW.from.line, c2 = cW.to.line;
                    if (cZ && (c3 == c4 || c2 == c4)) {
        ...
        function aG(db, c5) {
            ...
            for (; ;) {
                ...
                var da = Math.ceil((c6 + c7) / 2), cZ = c9(da);
                if (cZ > c5) {
                    c7 = da;
                    c3 = cZ
                } else {
        ...
        function b5(c0, c3) {
            ...
            var c5 = c2.offsetTop, c4 = c2.offsetLeft;
            if (I && c5 == 0 && c4 == 0) {
        ...
        function bH(c8, c7) {
            ...
            var c5 = bP(), c3 = bh(), de = bd + Math.floor(c7 / c5);
            var c9 = X(cy, de);
            if (c9 >= cy.size) {
                return {line: cy.size - 1, ch: cF(cy.size - 1).text.length}
            }
            var c0 = cF(c9), db = c0.text;
            var dg = b1.lineWrapping, c6 = dg ? de - g(cy, c9) : 0;
            if (c8 <= 0 && c6 == 0) {
                return {line: c9, ch: 0}
            }
            function df(di) {
            ...
            for (; ;) {
                ...
                var dh = Math.ceil((dd + c1) / 2), c2 = df(dh);
                if (c2 > c8) {
                    c1 = dh;
                    cZ = c2
                } else {
        ...
        function ce(c5) {
            var cZ = cW.inverted ? cW.from : cW.to, c7 = cF(cZ.line), c0 = cZ.ch - 1;
            var c4 = (c0 >= 0 && bp[c7.text.charAt(c0)]) || bp[c7.text.charAt(++c0)];
            if (!c4) {
                return
            }
            var c8 = c4.charAt(0), c6 = c4.charAt(1) == ">", di = c6 ? 1 : -1, dd = c7.styles;
            ...
            var de = bE({line: cZ.line, ch: c0}, {line: cZ.line, ch: c0 + 1}, dg), c1 = c9.pos != null && bE({
                    line: df,
                    ch: c9.pos
                }, {line: df, ch: c9.pos + 1}, dg);
            var db = ar(function () {
                de.clear();
                c1 && c1.clear()
            });
        ...
        function cu(c1) {
            var c0 = a7(c1), cZ = c0 && cF(c0 - 1).stateAfter;
            if (!cZ) {
                cZ = V(cb)
            } else {
                cZ = p(cb, cZ)
        ...
        function bS() {
            ...
            while (ch.length) {
                ...
                var c0 = a7(c2), cZ = c0 && cF(c0 - 1).stateAfter;
                if (cZ) {
                    cZ = p(cb, cZ)
                } else {
                    cZ = V(cb)
                }
                var c4 = 0, c1 = cb.compareStates, c7 = false, c6 = c0, c3 = false;
    ...
    var L = u.commands = {
        selectAll: function (am) {
            ...
            var ap = am.getCursor(true), ao = am.getCursor(false), an = !ad(ap, ao);
            ...
            var ap = am.getCursor();
            var ao = am.getLine(ap.line), an = Math.max(0, ao.search(/\S/));
            ...
            var ao = am.getCursor(), an = am.getLine(ao.line);
            if (ao.ch > 0 && ao.ch < an.length - 1) {
                am.replaceRange(an.charAt(ao.ch) + an.charAt(ao.ch - 1), {line: ao.line, ch: ao.ch - 1}, {
                    line: ao.line,
                    ch: ao.ch + 1
                })
            }
    ...
    e.inheritMarks = function (aq, au) {
        var ap = new e(aq), am = au && au.marked;
        if (am) {
            for (var ao = 0; ao < am.length; ++ao) {
                if (am[ao].to == null && am[ao].style) {
                    var an = ap.marked || (ap.marked = []), at = am[ao];
                    var ar = at.dup();
                    an.push(ar);
                    ar.attach(ap)
                }
    ...
    e.prototype = {
        replace: function (aq, ap, au) {
            var av = [], ao = this.marked, ar = ap == null ? this.text.length : ap;
            ...
            var at = this.text.length, am = an.marked, aq = this.marked;
            this.text += an.text;
            ...
            var am = this.marked, aq = an.marked;
            if (!am) {
                return
            }
            for (var ap = 0; ap < am.length; ++ap) {
                var at = am[ap], ar = at.to == null;
                if (ar && aq) {
            ...
            var aw = new b(this.text, at), ax = this.styles, au = 0;
            ...
            var am = this.text, aq = new b(am);
            while (aq.pos < ao && !aq.eol()) {
                aq.start = aq.pos;
                var an = ar.token(aq, ap)
            }
            return {start: aq.start, end: aq.pos, string: aq.current(), className: an || null, state: ap}
            ...
            var aF = this.styles, aw = this.text, aC = this.marked;
            var aQ = aw.length;
            ...
            if (!aw && am == null) {
                ...
                if (!aC || !aC.length) {
                    for (var aN = 0, ay = 0; ay < aQ; aN += 2) {
                        var aE = aF[aN], aP = aF[aN + 1], aH = aE.length;
                        if (ay + aH > aQ) {
                            aE = aE.slice(0, aQ - ay)
                        }
                        ay += aH;
    ...
    i.prototype = {
        chunkSize: function () {
            ...
            for (var ap = 0; ap < this.children.length; ++ap) {
                var am = this.children[ap], au = am.chunkSize();
                if (ao < au) {
                    var aq = Math.min(an, au - ao), av = am.height;
                    am.remove(ao, aq, ar);
            ...
            for (var ao = 0, aq = this.children.length; ao < aq; ++ao) {
                var am = this.children[ao], ar = am.chunkSize();
                if (an <= ar) {
            ...
            for (var an = 0, aq = this.children.length; an < aq; ++an) {
                var ar = this.children[an], ap = ar.chunkSize();
                if (am < ap) {
    ...
    function C(am, aq) {
        while (!am.lines) {
            for (var an = 0; ; ++an) {
                var ap = am.children[an], ao = ap.chunkSize();
                if (aq < ao) {
                    am = ap;
                    break
                }
    ...
    function Y(am) {
        ...
        var ar = am.parent, aq = q(ar.lines, am);
    ...
    function X(at, aq) {
        ...
        outer:do {
            for (var ap = 0, ar = at.children.length; ap < ar; ++ap) {
                var an = at.children[ap], am = an.height;
                if (aq < am) {
                    at = an;
                    continue outer
                }
        ...
        for (var ap = 0, ar = at.lines.length; ap < ar; ++ap) {
            var av = at.lines[ap], au = av.height;
            if (aq < au) {
                break
            }
            aq -= au
    ...
    function g(am, at) {
        ...
        outer:do {
            for (var an = 0, aq = am.children.length; an < aq; ++an) {
                var ar = am.children[an], ap = ar.chunkSize();
                if (at < ap) {
                    am = ar;
                    continue outer
                }
    ...
    k.prototype = {
        addChange: function (am, ar, an) {
            ...
            var ao = +new Date, au = this.done[this.done.length - 1], av = au && au[au.length - 1];
            var aq = ao - this.time;
            if (this.compound && au && !this.closed) {
                ...
                if (aq > 400 || !av || this.closed || av.start > am + an.length || av.start + av.added < am) {
                    ...
                    var at = Math.max(0, av.start - am), aw = Math.max(0, (am + an.length) - (av.start + av.added));
    ...
    function ak(an, aw) {
        ...
        var av = 0, au = 0, ar = false;
        for (var am = an; am; am = am.offsetParent) {
            var at = am.offsetLeft, ao = am.offsetTop;
            if (am == ap) {
                av += Math.abs(at);
                au += Math.abs(ao)
            } else {
...
CodeMirror.defineMode("xml", function (y, k) {
    ...
    return {
        startState: function () {
            return {tokenize: o, cc: [], indented: 0, startOfLine: true, tagName: null, context: null}
        }, token: function (D, C) {
            if (D.sol()) {
                C.startOfLine = true;
...
CodeMirror.defineMode("markdown", function (B, m) {
    ...
    var y = "header", d = "comment", A = "quote", z = "string", E = "hr", s = "link", D = "string", g = "em", j = "strong", w = "emstrong";
    var F = /^([*\-=_])(?:\s*\1){2,}\s*$/, p = /^[*\-+]\s+/, u = /^[0-9]+\.\s+/, n = /^(?:\={3,}|-{3,})$/, f = /^[^\[*_\\<>`]+/;
    ...
    return {
        startState: function () {
            ...
            return H.f(I, H)
        }, blankLine: o, getType: t
    }
}, "xml");
CodeMirror.defineMIME("text/x-markdown", "markdown");
Ext.define("Docs.History", {
    singleton: true, init: function () {
...
Ext.define("Docs.Auth", {
    singleton: true, requires: ["Ext.Ajax", "Ext.util.Cookies"], init: function (c, d) {
        Ext.Ajax.request({
...
Ext.define("Docs.view.Header", {
    ...
    initComponent: function () {
        if (Docs.otherProducts) {
            ...
            this.menu = Ext.create("Ext.menu.Menu", {renderTo: Ext.getBody(), plain: true, items: Docs.otherProducts})
        }
        this.callParent()
    },
    listeners: {
...
Ext.define("Docs.controller.Content", {
    extend: "Ext.app.Controller", MIDDLE: 1, title: "", loadIndex: function (b) {
...
Ext.define("Docs.Syntax", {
    singleton: true, highlight: function (b) {
...
Ext.define("Docs.ClassRegistry", {
    singleton: true, canonicalName: function (b) {
        if (!this.altNames) {
            this.altNames = {};
...
Ext.define("Docs.GuideSearch", {
    singleton: true, isEnabled: function () {
...
Ext.define("Docs.model.Setting", {
    ...
    proxy: {type: window.localStorage ? "localstorage" : "memory", id: Docs.data.localStorageDb + "-settings"}
});
Ext.define("Docs.view.TabMenu", {
    ...
    initComponent: function () {
        ...
        this.items = [{
            text: "Close other tabs", iconCls: "close", cls: "close-all", handler: function () {
...
Ext.define("Docs.model.Test", {
    extend: "Ext.data.Model",
    fields: ["id", "name", "href", "code", "options", {name: "status", defaultValue: "ready"}, "message"]
});
...
Ext.define("Docs.view.Signature", {
    singleton: true, render: function (f, d) {
        d = d || "short";
...
Ext.define("Docs.view.DocTree", {
    ...
    applyNodeTpl: function (b) {
        if (b.get("leaf")) {
            b.set("text", this.nodeTpl.apply({text: b.get("text"), url: b.raw.url}));
            b.commit()
        }
    },
...
Ext.define("Docs.Tip", {
    singleton: true, show: function (g, e, f) {
        f = f || "right";
        this.tips = this.tips || {};
        if (this.tips[f]) {
            var h = this.tips[f];
            ...
            var h = this.tips[f] = Ext.create("Ext.tip.ToolTip", {anchor: f, target: e, html: g});
            h.show()
        }
    }
});
...
Ext.define("Docs.view.comments.FilterField", {
    ...
    initComponent: function () {
        this.callParent(arguments);
        this.on({keyup: this.onKeyUp, specialkey: this.onSpecialKey, scope: this})
    },
    onKeyUp: function () {
...
Ext.define("Docs.view.comments.TopList", {
    ...
    initComponent: function () {
        ...
        new Docs.view.SimpleSelectBehavior(this.list, {select: this.onSelect, deselect: this.onDeselect, scope: this});
        this.callParent(arguments)
    },
    afterRender: function () {
        this.callParent(arguments);
    ...
    onFilter: function (b) {
        ...
        this.list.getStore().filter({property: this.displayField, value: b, anyMatch: true})
    },
...
Ext.define("Docs.view.examples.InlinePreview", {
    ...
    bodyPadding: "0 10",
    statics: {
        iframeCounter: 0, getNextIframeId: function () {
            this.iframeCounter++;
...
Ext.define("Docs.view.cls.Logic", {
    showPrivateClasses: false, constructor: function (b) {
        Ext.apply(this, b)
    }
});
...
Ext.define("Docs.view.comments.DragZone", {
    extend: "Ext.dd.DragZone", constructor: function (d, c) {
        this.view = d;
...
Ext.define("Docs.view.comments.DropZone", {
    extend: "Ext.dd.DropZone", constructor: function (d, c) {
        this.view = d;
        this.callParent([d.getEl(), c])
...
Ext.define("Docs.view.comments.TopLevelDropZone", {
    extend: "Ext.dd.DropZone", getTargetFromEvent: function (b) {
...
Ext.define("Docs.Comments", {
    ...
    fetchCountsAndSubscriptions: function (c, d) {
        this.request("jsonp", {
            url: "/comments_meta", method: "GET", success: function (a) {
    ...
    fetchSubscriptions: function (c, d) {
        this.request("jsonp", {
            url: "/subscriptions", method: "GET", success: function (a) {
    ...
    loadReplies: function (f, d, e) {
        this.request("jsonp", {url: "/replies", method: "GET", params: {parentId: f}, success: d, scope: e})
    },
    post: function (b) {
        this.request("ajax", {
            url: "/comments",
...
Ext.define("Docs.controller.Auth", {
    ...
    init: function () {
        this.control({"authHeaderForm, authForm": {login: this.login, logout: this.logout}});
    ...
    login: function (e, g, f, h) {
        Docs.Auth.login({
            username: g, password: f, remember: h, success: this.setLoggedIn, failure: function (a) {
                e.showMessage(a)
            }, scope: this
        })
    },
...
Ext.define("Docs.controller.Welcome", {
    ...
    baseUrl: "#",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#welcomeindex"}],
    init: function () {
...
Ext.define("Docs.controller.Failure", {
    extend: "Docs.controller.Content",
    baseUrl: "#",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#failure"}],
    show404: function (c) {
...
Ext.define("Docs.controller.Classes", {
    ...
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#classindex"}, {
        ref: "header",
        selector: "classheader"
    }, {ref: "overview", selector: "classoverview"}, {ref: "tabPanel", selector: "classtabpanel"}, {
        ref: "tree",
        selector: "#classtree"
    ...
    init: function () {
        ...
        }, this, {preventDefault: true, delegate: ".docClass"});
        this.control({
            classtree: {
                ...
                afterrender: function (b) {
                    b.el.addListener("click", function (i, k) {
                        var h = Ext.get(k).up(".member"), l = h.down(".meta .defined-in"), j = l.getAttribute("rel"), a = h.getAttribute("id");
                    ...
                    }, this, {preventDefault: true, delegate: ".expandable"});
                    b.el.addListener("click", Ext.emptyFn, this, {preventDefault: true, delegate: ".not-expandable"})
                }
            }, treecontainer: {
                afterrender: function (b) {
                    ...
                    }, this, {delegate: ".x-resizable-handle"})
                }
            }, doctabs: {
                tabClose: function (b) {
...
Ext.define("Docs.controller.Examples", {
    ...
    baseUrl: "#!/example",
    title: "Examples",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#exampleindex"}, {
        ref: "tree",
        ...
        this.control({
            "#exampletree": {
                ...
                afterrender: function (b) {
                    ...
                    }, this, {delegate: "button.new-window"})
                }
            }, touchexamplecontainer: {
                afterrender: function (b) {
                    b.el.addListener("click", function (d, a) {
                        this.changeDevice("tablet")
                    }, this, {delegate: "button.tablet"});
                    b.el.addListener("click", function (d, a) {
                        this.changeDevice("phone")
                    }, this, {delegate: "button.phone"});
                    b.el.addListener("click", function (d, a) {
                        this.changeOrientation("portrait")
                    }, this, {delegate: "button.portrait"});
                    b.el.addListener("click", function (d, a) {
                        this.changeOrientation("landscape")
                    }, this, {delegate: "button.landscape"})
                }
            }
        })
    },
...
Ext.define("Docs.controller.Guides", {
    ...
    baseUrl: "#!/guide",
    title: "Guides",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#guideindex"}, {
        ref: "tree",
        selector: "#guidetree"
        ...
        this.control({
            "#guidetree": {
                ...
                afterrender: function (b) {
                    ...
                    }, this, {preventDefault: true, delegate: ".guide"})
                }
            }, doctabs: {
                tabClose: function (b) {
...
Ext.define("Docs.controller.Videos", {
    ...
    baseUrl: "#!/video",
    title: "Videos",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#videoindex"}, {
        ref: "tree",
        selector: "#videotree"
    }],
    init: function () {
...
Ext.define("Docs.controller.CommentCounts", {
    ...
    refs: [{ref: "class", selector: "classoverview"}, {ref: "classIndex", selector: "#classindex"}, {
        ref: "guide",
        selector: "#guide"
    }, {ref: "guideIndex", selector: "#guideindex"}, {ref: "video", selector: "#video"}, {
        ref: "videoIndex",
        selector: "#videoindex"
    }],
    init: function () {
...
Ext.define("Docs.controller.Tests", {
    extend: "Docs.controller.Content",
    baseUrl: "#!/tests",
    refs: [{ref: "viewport", selector: "#viewport"}, {ref: "index", selector: "#testsindex"}],
    init: function () {
        this.addEvents("loadIndex");
...
Ext.define("Docs.Settings", {
    ...
    defaults: {
        show: {
            ...
            inherited: true,
            accessor: true
        }, comments: {hideRead: false}, showPrivateClasses: false, classTreeLogic: "PackageLogic"
    },
    set: function (d, f) {
...
Ext.define("Docs.controller.Tabs", {
    ...
    refs: [{ref: "welcomeIndex", selector: "#welcomeindex"}, {
        ref: "classIndex",
        selector: "#classindex"
    }, {ref: "guideIndex", selector: "#guideindex"}, {ref: "videoIndex", selector: "#videoindex"}, {
        ref: "exampleIndex",
        selector: "#exampleindex"
    }, {ref: "testsIndex", selector: "#testsindex"}, {
        ref: "commentIndex",
        selector: "#commentindex"
    }, {ref: "classTree", selector: "#classtree"}, {ref: "guideTree", selector: "#guidetree"}, {
        ref: "exampleTree",
        selector: "#exampletree"
    }, {ref: "videoTree", selector: "#videotree"}, {ref: "doctabs", selector: "#doctabs"}],
    init: function () {
    ...
    addTab: function (d, c) {
        ...
        this.getDoctabs().addTab({href: d.url, text: d.text, iconCls: d.iconCls}, c)
    },
    getTree: function (b) {
        if (/#!?\/api/.test(b)) {
...
Ext.define("Docs.controller.Comments", {
    ...
    fetchRecentComments: function (f) {
        ...
        Docs.Comments.request("jsonp", {
            url: "/comments_recent", method: "GET", params: d, success: function (a) {
...
Ext.define("Docs.view.Tabs", {
    ...
    refresh: function () {
        ...
        for (var j = 0; j < f; j++) {
            ...
            var g = Ext.apply(h, {visible: true, active: this.activeTab === h.href, width: this.tabWidth()});
    ...
    swapLastTabWith: function (d) {
        ...
        if (e) {
            ...
            Ext.get(f).setStyle({visibility: "visible", width: String(this.tabWidth()) + "px"});
    ...
    createMenu: function () {
        var b = new Docs.view.TabMenu({
            listeners: {
                closeAllTabs: this.closeAllTabs, tabItemClick: function (a) {
...
Ext.define("Docs.view.cls.Index", {
    ...
    getTab: function () {
        ...
        return b ? {cls: "classes", href: "#!/api", tooltip: "API Documentation"} : false
    }
});
...
Ext.define("Docs.view.GroupTree", {
    extend: "Docs.view.DocTree", alias: "widget.grouptree", initComponent: function () {
        this.root = {text: "Root", children: this.buildTree(this.data)};
        this.callParent()
    }, buildTree: function (b) {
        return Ext.Array.map(b, function (a) {
            if (a.items) {
                return {text: a.title, expanded: true, iconCls: "icon-pkg", children: this.buildTree(a.items)}
            } else {
...
Ext.define("Docs.view.auth.HeaderForm", {
    ...
    afterRender: function () {
        this.callParent(arguments);
        this.getEl().addListener("click", this.showLoginForm, this, {preventDefault: true, delegate: ".login"});
        this.getEl().addListener("click", function () {
            this.fireEvent("logout", this)
        }, this, {preventDefault: true, delegate: ".logout"})
    },
...
Ext.define("Docs.view.comments.Users", {
    ...
    initComponent: function () {
        this.items = [this.tabpanel = Ext.widget("tabpanel", {
            ...
            autoScroll: true,
            store: Ext.create("Ext.data.Store", {fields: ["userName", "score", "emailHash", "mod"]}),
            allowDeselect: true,
    ...
    onFilter: function (b) {
        this.list.getSelectionModel().deselectAll();
        this.list.getStore().clearFilter(true);
        this.list.getStore().filter({property: "userName", value: b, anyMatch: true})
    },
    deselectAll: function () {
        this.list.getSelectionModel().deselectAll()
    },
...
Ext.define("Docs.view.cls.Header", {
    ...
    classLinkEvent: function (d, e, f) {
        this.el.on(d, e, f, {preventDefault: true, delegate: "a.class-source-link"})
    },
    createFileMenu: function (b) {
        return new Ext.menu.Menu({
            items: Ext.Array.map(b, function (a) {
                return {
                    text: a.filename, handler: function () {
...
Ext.define("Docs.view.ThumbList", {
    ...
    initComponent: function () {
        ...
        this.store = Ext.create("Ext.data.JsonStore", {fields: ["id", "title", "items"]});
    ...
    flattenSubgroups: function (c) {
        ...
        return Ext.Array.map(c, function (a) {
            return {
                id: a.id, title: a.title, items: Ext.Array.map(a.items, function (b) {
                    if (b.items) {
...
Ext.define("Docs.view.examples.Index", {
    ...
    getTab: function () {
        ...
        return b ? {cls: "examples", href: "#!/example", tooltip: "Examples"} : false
    }
});
Ext.define("Docs.view.examples.Inline", {
    ...
    initComponent: function () {
        this.options = Ext.apply({device: "phone", orientation: "landscape"}, this.options);
        this.items = [this.editor = Ext.create("Docs.view.examples.InlineEditor", {
            cmpName: "code",
            value: this.value,
            listeners: {init: this.updateHeight, change: this.updateHeight, scope: this}
        }), this.preview = Ext.create("Docs.view.examples.InlinePreview", {cmpName: "preview", options: this.options})];
...
Ext.define("Docs.controller.InlineExamples", {
    ...
    init: function () {
        this.control({
            ...
            }, guidecontainer: {resize: this.createResizer(".guide-container"), afterload: this.replaceExampleDivs}
        })
    },
...
Ext.define("Docs.view.tests.Index", {
    ...
    padding: 10,
    initComponent: function () {
        this.store = Ext.create("Ext.data.Store", {model: "Docs.model.Test", data: []});
        ...
        this.batchRunner = Ext.create("Docs.view.tests.BatchRunner", {
            height: 0,
            listeners: {start: this.disable, finish: this.enable, statuschange: this.updateTestStatus, scope: this}
        });
        this.items = [{html: "<h1>Inline examples test page</h1>", height: 30}, {
            ...
            items: [{
                itemId: "testcontrols",
                layout: "hbox",
                items: [{html: "<b>Double-click</b> to run an example, or", margin: "5 5 5 0"}, {
                    xtype: "button",
...
Ext.define("Docs.view.cls.PackageLogic", {
    ...
    packageNode: function (b) {
        return {text: Docs.ClassRegistry.shortName(b), iconCls: "icon-pkg", leaf: false, children: []}
    }
});
Ext.define("Docs.view.cls.InheritanceLogic", {
    extend: "Docs.view.cls.Logic", create: function () {
        this.root = {children: [], text: "Root"};
        this.privates = [];
        ...
        return {text: b.name, url: "#!/api/" + b.name, iconCls: b.icon, cls: b["private"] ? "private" : ""}
    }, addClass: function (e) {
        var d = e["extends"];
        if (!d || d === "Object") {
...
Ext.define("Docs.view.cls.Tree", {
    ...
    setupButtonClickHandler: function () {
        this.el.addListener("click", function (g, h) {
            var f = Ext.get(h), e = Ext.get(Ext.query(".cls-grouping button.selected")[0]);
            if (e.dom === f.dom) {
                return
            }
...
Ext.define("Docs.view.TreeContainer", {
    ...
    header: false,
    initComponent: function () {
        this.items = [{}, {xtype: "classtree", id: "classtree", data: Docs.data.classes}, {
            xtype: "grouptree",
            id: "exampletree",
            data: Docs.data.examples,
            convert: function (b) {
                return {leaf: true, text: b.title, url: "#!/example/" + b.name, iconCls: "icon-example"}
            }
        }, {
            xtype: "grouptree", id: "guidetree", data: Docs.data.guides, convert: function (b) {
                return {leaf: true, text: b.title, url: "#!/guide/" + b.name, iconCls: "icon-guide"}
            }
        }, {
            xtype: "grouptree", id: "videotree", data: Docs.data.videos, convert: function (b) {
                return {leaf: true, text: b.title, url: "#!/video/" + b.name, iconCls: "icon-video"}
            }
        }];
        this.callParent()
    },
...
Ext.define("Docs.view.comments.Expander", {
    ...
    initComponent: function () {
        this.tpl = new Ext.XTemplate('<a href="#" class="side toggleComments"><span></span></a>', '<a href="#" class="name toggleComments">', "{[this.renderCount(values.count)]}", "</a>", {renderCount: this.renderCount});
    ...
    afterRender: function () {
        ...
        new Docs.view.comments.TopLevelDropZone(this.getEl().down(".side.toggleComments"), {onValidDrop: Ext.Function.bind(this.setParent, this)})
    },
...
Ext.define("Docs.view.comments.RepliesExpander", {
    ...
    afterRender: function () {
        this.callParent(arguments);
        this.getEl().down(".replies-button").on("click", this.toggle, this, {preventDefault: true})
    },
    toggle: function () {
        this.expanded ? this.collapse() : this.expand()
    },
...
Ext.define("Docs.model.Comment", {
    ...
    vote: function (c, d) {
        this.request({
            method: "POST", url: "/comments/" + this.get("id"), params: {vote: c}, success: function (a) {
                this.set("upVote", a.direction === "up");
                this.set("downVote", a.direction === "down");
                this.set("score", a.total);
                this.commit()
            }, failure: Ext.Function.bind(d.failure, d.scope), scope: this
        })
    },
    loadContent: function (c, d) {
        this.request({
            url: "/comments/" + this.get("id"), method: "GET", success: function (a) {
                c.call(d, a.content)
            }, scope: this
        })
    },
    saveContent: function (b) {
        this.request({
            url: "/comments/" + this.get("id"), method: "POST", params: {content: b}, success: function (a) {
    ...
    markRead: function () {
        this.request({
            url: "/comments/" + this.get("id") + "/read", method: "POST", success: function () {
                this.set("read", true);
                this.commit()
            }, scope: this
        })
    ...
    request: function (b) {
        Docs.Comments.request("ajax", {
            url: b.url, method: b.method, params: b.params, callback: function (h, f, a) {
                var g = Ext.JSON.decode(a.responseText);
                if (f && g.success) {
...
Ext.define("Docs.model.Target", {
    ...
    fields: ["id", "type", "cls", "member", "score", {
        name: "text", convert: function (e, f) {
            var d = f.data;
            if (d.type === "class") {
    ...
    proxy: {type: "comments", url: "/targets", reader: {type: "json", root: "data"}}
});
...
Ext.define("Docs.model.Tag", {
    ...
    proxy: {type: "comments", url: "/tags", reader: {type: "json", root: "data"}}
});
...
Ext.define("Docs.view.comments.TagEditor", {
    ...
    statics: {
        cachedStore: undefined, getStore: function () {
            if (!this.cachedStore) {
                this.cachedStore = Ext.create("Ext.data.Store", {
                    model: "Docs.model.Tag", listeners: {
                        load: function () {
    ...
    initComponent: function () {
        this.items = [{
            ...
            listeners: {select: this.handleSelect, blur: this.destroy, keyup: this.onKeyUp, scope: this}
        }];
        this.callParent(arguments)
    },
    popup: function (b) {
...
Ext.define("Docs.view.comments.List", {
    ...
    afterRender: function () {
        ...
        if (this.enableDragDrop) {
            ...
            new Docs.view.comments.DropZone(this, {onValidDrop: Ext.Function.bind(this.setParent, this)})
        }
    },
    delegateClick: function (e, f, d) {
        ...
        }, this, {preventDefault: true, delegate: e})
    },
    vote: function (e, f, d) {
        if (!Docs.Auth.isLoggedIn()) {
...
Ext.define("Docs.view.comments.FullList", {
    ...
    items: [{
        ...
        autoScroll: true,
        cls: "iScroll",
        items: [{xtype: "commentsList", id: "recentcomments", showTarget: true}, {xtype: "commentsPager"}]
    }],
    afterRender: function () {
        this.callParent(arguments);
        this.initCheckboxes();
...
Ext.define("Docs.view.comments.Index", {
    ...
    margin: "10 0 0 0",
    layout: "border",
    items: [{region: "center", xtype: "commentsFullList"}, {
        region: "east",
        itemId: "cardPanel",
        layout: "border",
        width: 300,
        ...
        items: [{xtype: "commentsUsers"}, {xtype: "commentsTargets"}, {xtype: "commentsTags"}]
    }],
    initComponent: function () {
        this.callParent(arguments);
...
Ext.define("Docs.view.HoverMenuButton", {
    ...
    onRender: function () {
        ...
        this.getEl().on({
            ...
            }, mouseover: this.deferShowMenu, mouseout: this.deferHideMenu, scope: this
        })
    },
    onDestroy: function () {
        if (this.menu) {
    ...
    renderMenu: function () {
        this.menu = Ext.create("Docs.view.HoverMenu", {store: this.store, columnHeight: this.getColumnHeight()});
        this.menu.getEl().on({
            click: function (b) {
                this.menu.hide();
                b.preventDefault()
                ...
                clearTimeout(this.hideTimeout)
            }, mouseout: this.deferHideMenu, scope: this
        });
    ...
    deferShowMenu: function () {
        ...
        Docs.view.HoverMenuButton.showTimeout = Ext.Function.defer(function () {
            ...
            clearTimeout(this.hideTimeout);
            this.menu.show();
            var j = this.getEl().getXY(), n = Ext.ComponentQuery.query("classoverview toolbar")[0], k = j[0] - 10, l = n.getEl().getXY(), i = n.getWidth(), m = this.menu.getEl().getWidth(), h = Ext.getCmp("doctabs").getWidth();
            if (m > h) {
                k = 0
            } else {
                if ((k + m) > h) {
...
Ext.define("Docs.view.cls.Toolbar", {
    ...
    initComponent: function () {
        ...
        Ext.Array.forEach(Docs.data.memberTypes, function (e) {
            ...
            if (a.length > 0) {
                var f = this.createMemberButton({text: e.toolbar_title || e.title, type: e.name, members: a});
        ...
        var b = this;
        this.items = this.items.concat([{xtype: "tbfill"}, this.filterField = Ext.widget("triggerfield", {
            triggerCls: "reset",
            cls: "member-filter",
            hideTrigger: true,
        ...
        }), {xtype: "tbspacer", width: 10}, this.commentCount = this.createCommentCount(), {
            xtype: "button",
            text: "Show",
    ...
    createStore: function (c) {
        var d = Ext.create("Ext.data.Store", {fields: ["id", "url", "label", "inherited", "accessor", "meta", "commentCount"]});
        d.add(c);
        return d
    },
...
Ext.define("Docs.view.cls.Overview", {
    ...
    scrollToEl: function (j, h) {
        ...
        if (g) {
            ...
            this.scrollToView(g, {highlight: true, offset: (h || 0) - (f ? i : i - 10)})
        }
    },
    load: function (b) {
        this.docClass = b;
        ...
        this.toolbar = Ext.create("Docs.view.cls.Toolbar", {
            ...
            listeners: {
                ...
                }, commentcountclick: this.expandClassComments, scope: this
            }
        });
    ...
    initComments: function () {
        ...
        Ext.Array.forEach(Ext.query(".member"), function (c) {
            var d = new Docs.view.comments.MemberWrap({parent: this, className: this.docClass.name, el: c});
...
Ext.define("Docs.view.cls.Container", {
    ...
    padding: "5 10 0 10",
    initComponent: function () {
        this.items = [Ext.create("Docs.view.cls.Header", {region: "north"}), Ext.create("Docs.view.cls.Overview", {region: "center"})];
        this.callParent(arguments)
    }
});
    ...
    initComponent: function () {
        this.items = [{
            ...
            items: [{
                ...
                xtype: "container",
                layout: "hbox",
                items: [{xtype: "docheader"}, {xtype: "container", flex: 1}, {
                    id: "loginContainer",
                    xtype: "authHeaderForm",
                    padding: "10 20 0 0"
                }, {xtype: "searchcontainer", id: "search-container", width: 230, margin: "4 0 0 0"}]
            }, {xtype: "doctabs"}]
        }, {
            region: "center",
            layout: "border",
            items: [{
                ...
                items: {
                    ...
                    items: [{autoScroll: true, xtype: "welcomeindex", id: "welcomeindex"}, {
                        xtype: "container",
                        id: "failure"
                        ...
                        id: "example"
                    }, {xtype: "testsindex", id: "testsindex"}, {xtype: "commentindex", id: "commentindex"}]
                }
            }]
        }, {region: "south", id: "footer", height: 20, contentEl: "footer-content"}];
        this.callParent(arguments)
    },
...
Ext.define("Docs.view.comments.ListWithForm", {
    ...
    initComponent: function () {
        this.items = [this.list = new Docs.view.comments.List({enableDragDrop: true})];
    ...
    showCommentingForm: function () {
        ...
        if (!this.commentingForm) {
            this.commentingForm = new Docs.view.comments.Form({
                ...
                listeners: {submit: this.postComment, subscriptionChange: this.subscribe, scope: this}
            });
    ...
    postComment: function (b) {
        Docs.Comments.post({
            target: this.target, parentId: this.parentId, content: b, callback: function (a) {
...
!function () {
    ...
    (function () {
        function h(J) {
            ...
            function I(R) {
                var M = R.substring(1, R.length - 1).match(/\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\S\s]|[^\\]/g), R = [], O = M[0] === "^", S = ["["];
                O && S.push("^");
            ...
            for (var p = {b: 8, t: 9, n: 10, v: 11, f: 12, r: 13}, v = [], C = 0, H = J.length; C < H; ++C) {
                E = J[C];
        ...
        function f(v) {
            for (var C = void 0, y = v.firstChild; y; y = y.nextSibling) {
                var p = y.nodeType, C = p === 1 ? C ? v : y : p === 3 ? e.test(y.nodeValue) ? v : C : C
            }
            return C === v ? void 0 : C
        }
        ...
        function A(y, E) {
            function D(R) {
                for (var K = R.e, J = [K, "pln"], Q = 0, L = R.a.match(C) || [], F = {}, H = 0, O = L.length; H < O; ++H) {
                    ...
                    if (N) {
                        N = T[1];
                        var I = P.indexOf(N), G = I + N.length;
        ...
        function q(J, G, F) {
            ...
            function L(N) {
                function M(P, U) {
                    var T = U ? P.cloneNode(!1) : P, S = P.parentNode;
                    if (S) {
                        var S = M(S, 1), R = P.nextSibling;
                        S.appendChild(T);
                        for (var Q = R; Q; Q = R) {
        ...
        function o(ad) {
            var aa = ad.h;
            try {
                var X = g(ad.c, ad.i), ac = X.a;
                ad.a = ac;
                ad.d = X.d;
                ad.e = 0;
                s(aa, ac)(ad);
                var J = /\bMSIE\s(\d+)/.exec(navigator.userAgent), J = J && +J[1] <= 8, aa = /\n/g, C = ad.a, R = C.length, X = 0, U = ad.d, T = U.length, ac = 0, ab = ad.g, V = ab.length, K = 0;
                ab[V] = R;
                var Q, Z;
                for (Z = Q = 0; Z < V;) {
                ...
                try {
                    for (; ac < T;) {
                        ...
                        if (N.nodeType !== 1 && (F = C.substring(X, I))) {
                            J && (F = F.replace(aa, "\r"));
                            N.nodeValue = F;
                            var y = N.ownerDocument, P = y.createElement("span");
                            P.className = ab[K + 1];
                            var E = N.parentNode;
                            E.replaceChild(P, N);
                            P.appendChild(N);
        ...
        B(A([], [["atv", /^[\S\s]+/]]), ["uq.val"]);
        B(u({keywords: n, hashComments: !0, cStyleComments: !0, types: i}), ["c", "cc", "cpp", "cxx", "cyc", "m"]);
        B(u({keywords: "null,true,false"}), ["json"]);
        B(u({keywords: l, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: i}), ["cs"]);
        B(u({keywords: m, cStyleComments: !0}), ["java"]);
        B(u({keywords: r, hashComments: !0, multiLineStrings: !0}), ["bash", "bsh", "csh", "sh"]);
        ...
        B(u({keywords: x, cStyleComments: !0, regexLiterals: !0}), ["javascript", "js"]);
        B(u({
        ...
        B(u({keywords: d, cStyleComments: !0, multilineStrings: !0}), ["rc", "rs", "rust"]);
        B(A([], [["str", /^[\S\s]+/]]), ["regex"]);
        var b = z.PR = {
            createSimpleLexer: A,
                ...
                function N() {
                    for (var v = z.PR_SHOULD_USE_CONTINUATION ? R.now() + 250 : Infinity; L < G.length && R.now() < v; L++) {
                        for (var Y = G[L], W = M, U = Y; U = U.previousSibling;) {
                            var p = U.nodeType, X = (p === 7 || p === 8) && U.nodeValue;
                        ...
                        if ((W !== M || P.test(U)) && !C.test(U)) {
                            ...
                            if (!p) {
                                ...
                                if (y.test(Y.tagName)) {
                                    ...
                                    var X = Y.currentStyle, V = E.defaultView, X = (X = X ? X.whiteSpace : V && V.getComputedStyle ? V.getComputedStyle(Y, a).getPropertyValue("white-space") : 0) && "pre" === X.substring(0, 3)
                                }
                                V = W.linenums;
                                if (!(V = V === "true" || +V)) {
